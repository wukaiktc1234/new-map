 ...
 * 发票明细行项目实体类
 */
@TableName("electronic_invoice_item")
@Schema(description = "发票明细行项目实体")
public class ElectronicInvoiceItem {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ElectronicInvoiceItem)) return false;
        final ElectronicInvoiceItem other = (ElectronicInvoiceItem) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof ElectronicInvoiceItem;
    }
    ...
    public java.lang.String toString() {
        return "ElectronicInvoiceItem(id=" + this.getId() + ", tenantId=" + this.getTenantId() + ", invoiceId=" + this.getInvoiceId() + ", itemNo=" + this.getItemNo() + ", goodsCode=" + this.getGoodsCode() + ", goodsName=" + this.getGoodsName() + ", specification=" + this.getSpecification() + ", unit=" + this.getUnit() + ", quantity=" + this.getQuantity() + ", unitPrice=" + this.getUnitPrice() + ", amount=" + this.getAmount() + ", taxRate=" + this.getTaxRate() + ", taxAmount=" + this.getTaxAmount() + ", discountAmount=" + this.getDiscountAmount() + ", remark=" + this.getRemark() + ", createdAt=" + this.getCreatedAt() + ", createdBy=" + this.getCreatedBy() + ", deleted=" + this.getDeleted() + ")";
    }
}
