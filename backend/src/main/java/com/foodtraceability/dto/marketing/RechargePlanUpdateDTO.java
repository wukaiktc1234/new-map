 ...
 * 所有字段可选，仅更新非null字段
 */
@Schema(description = "充值方案更新请求")
public class RechargePlanUpdateDTO {
    ...
    @Schema(description = "赠送类型: balance/coupon/points/mixed")
    private String bonusType;

    @Schema(description = "赠送有效期天数（-1永久，0跟随系统默认）")
    ...
    @Schema(description = "方案生效时间（YYYY-MM-DD HH:mm:ss）")
    private String startTime;

    @Schema(description = "方案失效时间（YYYY-MM-DD HH:mm:ss）")
