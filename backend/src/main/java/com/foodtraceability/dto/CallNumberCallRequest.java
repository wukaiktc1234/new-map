 ...
 * 叫号请求DTO
 */
public class CallNumberCallRequest {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof CallNumberCallRequest)) return false;
        final CallNumberCallRequest other = (CallNumberCallRequest) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof CallNumberCallRequest;
    }
    ...
    public String toString() {
        return "CallNumberCallRequest(orderId=" + this.getOrderId() + ", orderNumber=" + this.getOrderNumber() + ", tableNumber=" + this.getTableNumber() + ", orderType=" + this.getOrderType() + ", itemCount=" + this.getItemCount() + ")";
    }
}
