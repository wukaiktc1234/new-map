...
public class PurchaseRequestUpdateDTO {
    ...
    public static class PurchaseRequestItemDTO {
        ...
        public boolean equals(final java.lang.Object o) {
            ...
            if (!(o instanceof PurchaseRequestUpdateDTO.PurchaseRequestItemDTO)) return false;
            final PurchaseRequestUpdateDTO.PurchaseRequestItemDTO other = (PurchaseRequestUpdateDTO.PurchaseRequestItemDTO) o;
        ...
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof PurchaseRequestUpdateDTO.PurchaseRequestItemDTO;
        }
        ...
        public java.lang.String toString() {
            return "PurchaseRequestUpdateDTO.PurchaseRequestItemDTO(itemId=" + this.getItemId() + ", foodId=" + this.getFoodId() + ", foodName=" + this.getFoodName() + ", foodCode=" + this.getFoodCode() + ", specification=" + this.getSpecification() + ", quantity=" + this.getQuantity() + ", unit=" + this.getUnit() + ", estimatedPrice=" + this.getEstimatedPrice() + ", remark=" + this.getRemark() + ", plannedReceiverType=" + this.getPlannedReceiverType() + ", plannedStoreId=" + this.getPlannedStoreId() + ", plannedWarehouseId=" + this.getPlannedWarehouseId() + ")";
        }
    }

    public PurchaseRequestUpdateDTO() {
    }
    ...
    public boolean equals(final java.lang.Object o) {
        if (o == this) return true;
        if (!(o instanceof PurchaseRequestUpdateDTO)) return false;
        final PurchaseRequestUpdateDTO other = (PurchaseRequestUpdateDTO) o;
        if (!other.canEqual((java.lang.Object) this)) return false;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof PurchaseRequestUpdateDTO;
    }
    ...
    @java.lang.Override
    public java.lang.String toString() {
        return "PurchaseRequestUpdateDTO(requestId=" + this.getRequestId() + ", title=" + this.getTitle() + ", requestType=" + this.getRequestType() + ", departmentId=" + this.getDepartmentId() + ", departmentName=" + this.getDepartmentName() + ", priority=" + this.getPriority() + ", expectedDate=" + this.getExpectedDate() + ", description=" + this.getDescription() + ", budgetId=" + this.getBudgetId() + ", items=" + this.getItems() + ")";
    }
}
