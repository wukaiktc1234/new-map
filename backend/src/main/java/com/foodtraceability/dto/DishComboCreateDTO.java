...
@Schema(description = "创建套餐请求DTO")
public class DishComboCreateDTO {
    @NotBlank(message = "套餐名称不能为空")
    @Schema(description = "套餐名称")
    private String comboName;
    @Schema(description = "套餐价格（可选，默认为0，在产品定价中设置）")
    ...
    public DishComboCreateDTO() {
    }

    @java.lang.Override
    public boolean equals(final java.lang.Object o) {
        if (o == this) return true;
        if (!(o instanceof DishComboCreateDTO)) return false;
        final DishComboCreateDTO other = (DishComboCreateDTO) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof DishComboCreateDTO;
    }
    ...
    public java.lang.String toString() {
        return "DishComboCreateDTO(comboName=" + this.getComboName() + ", price=" + this.getPrice() + ", description=" + this.getDescription() + ", comboType=" + this.getComboType() + ", peopleCount=" + this.getPeopleCount() + ", status=" + this.getStatus() + ", ingredients=" + this.getIngredients() + ")";
    }
}
