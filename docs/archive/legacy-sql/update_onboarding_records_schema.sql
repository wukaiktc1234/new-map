...
-- 标注时间：2026-06-30
-- ============================================================
ALTER TABLE onboarding_records MODIFY COLUMN department_id BIGINT;
ALTER TABLE onboarding_records MODIFY COLUMN store_id BIGINT;
ALTER TABLE onboarding_records MODIFY COLUMN position_id BIGINT;
