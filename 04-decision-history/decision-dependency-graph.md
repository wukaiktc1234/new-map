...
```
VERIFIED LOCK → OPEN PRODUCT → OPEN ARCHITECTURE → ENGINEERING READY
     ↓                ↓                ↓                    ↓
 基础数据锁定      业务规则定义     技术方案确定         工程实施
```
...
| 决策ID | 决策标题 | DEPENDS_ON | BLOCKS | UNLOCKS | INDEPENDENT |
|--------|----------|------------|--------|---------|-------------|
| DEC-004 | Customer/Member 关系定义 | A005, B001, B004 | D010, E007 | D010, E007 | - |
| DEC-006 | Product/Food/Material 边界 | A001, A002, B001 | D010, D011, E005 | D010, D011, E005 | - |
...
LOCK-A001 (foods) + LOCK-A002 (material_archives) 
...
LOCK-A005 → LOCK-A010 → DEC-013 → DEC-007
                    或
LOCK-A001 + A002 → DEC-006 → DEC-010 → DEC-009
```
