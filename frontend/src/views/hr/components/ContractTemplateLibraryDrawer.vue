...
<template>
  ...
  >
    <!-- 新增模板按钮 -->
    <template #header>
      <span style="font-size: var(--fts-font-size-lg); font-weight: 600;">合同模板库</span>
    ...
    <!-- 模板详情对话框 -->
    <el-dialog v-model="detailDialogVisible" title="模板详情" width="680px" class="fts-dialog--md" destroy-on-close lock-scroll="false" :teleported="false">
    ...
    <!-- 编辑模板对话框 -->
    <el-dialog v-model="editDialogVisible" :title="editTemplate.templateId ? '编辑模板' : '新增模板'" width="680px" class="fts-dialog--md" destroy-on-close lock-scroll="false" :teleported="false">
